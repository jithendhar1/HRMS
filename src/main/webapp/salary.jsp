					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#delete_salary"><i class="fa fa-plus"></i> Delete Salary</a> 
							<a href="#" class="btn add-btn" data-toggle="modal" data-target="#edit_salary"><i class="fa fa-plus"> </i> Edit Salary</a> 
