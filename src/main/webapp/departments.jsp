    ...
    <div class="page-wrapper">
                ...
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus select-focus">
                            ...
                            <input type="text" name="id" id="date">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_department.jsp?id=<%= department.getId() %>">Edit</a>
                </td>
                <td>
                    <a href="DeleteDepartmentSrv?id=<%= department.getId() %>">Delete</a>
                </td>
            </tr>
            <%
                }
...
<script>
    $(document).ready(function () {
        $("#filterButton").click(function () {
            ...
            var departmentFilter = $("#DepartmentName").val();
            var idFilter = $("#id").val();
