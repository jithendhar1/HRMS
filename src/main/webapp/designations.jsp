            ...
            <div class="row filter-row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="form-group form-focus select-focus">
                        ...
                        <input type="text" name="id" id="department">
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="edit_designation.jsp?id=<%= designation.getId() %>">Edit</a>
                    </td>
                    <td>
                       <a href="DeleteDesignationSrv?id=<%= designation.getId() %>">Delete</a> </td>
                </tr>
                <%
                    }
                %>
...
<script>
    $(document).ready(function () {
        $("#filterButton").click(function () {
            ...
            var departmentFilter = $("#DesignationName").val();
            var idFilter = $("#id").val();
