    ...
    <body>
        ...
        <jsp:include page="sidebar.jsp" />
            ...
            <div class="page-wrapper">
						...
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								...
								<div class="view-icons">
									<a href="projects.jsp" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
									<a href="project-list.jsp" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
										<tr>
											<td>
												<a href="project-view.jsp">Office Management</a>
											</td>
											<td>PRO-0001</td>
											<td>
											...
											<td>
												<ul class="team-members text-nowrap">
													...
													<li>
														<a href="#" title="John Smith" data-toggle="tooltip"><img alt="" src="assets/profiles/avatar-10.jpg"></a>
													</li>
													<li>
														<a href="#" title="Mike Litorus" data-toggle="tooltip"><img alt="" src="assets/profiles/avatar-05.jpg"></a>
													</li>
										...
										<tr>
											<td>
												<a href="project-view.jsp">Project Management</a>
											</td>
											<td>PRO-0002</td>
											<td>
												<ul class="team-members">
										...
										<tr>
											<td>
												<a href="project-view.jsp">Video Calling App</a>
											</td>
											<td>PRO-0003</td>
											<td>
												<ul class="team-members">
										...
										<tr>
											<td>
												<a href="project-view.jsp">Hospital Administration</a>
											</td>
											<td>PRO-0004</td>
											<td>
												<ul class="team-members">
				...
				<!--<jsp:include page="includes/modals/projects/add.jsp" />-->
				<!-- /Create Project Modal -->
				
				<!-- Edit Project Modal -->
				
				<!--<jsp:include page="includes/modals/projects/edit.jsp" />-->
				<!-- /Edit Project Modal -->
				
				<!-- Delete Project Modal -->
				<!--<jsp:include page="includes/modals/projects/delete.jsp" />-->
				<!-- /Delete Project Modal -->
