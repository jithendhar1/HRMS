...
public class AddProjectSrv extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         //project_id, projectname, Clientid, startdate, enddate, rate,
       ...
       AddProjectServiceImp employee = new AddProjectServiceImp();
        status=employee.addProject(projectname, Clientid, startdate, enddate, rate, hourly, priority, projectleader, addteam, description, uploadfile);
